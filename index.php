<?php include 'header.php';?>
    ...
    use PHPMailer\PHPMailer\Exception;
                    ...
                    function clean_input($input){
                      ...
                      if($_SERVER['REQUEST_METHOD'] == 'POST'){
                           ...
                           $texto_mensagem='E-mail enviado do sistema de reservas do site'.'<br><br>'.
                           'Nome: '.$nome.'<br> 
                           E-mail: '.$email.'<br>
    ...
    try {
        ...
        // Nome do usuário
        $mail->Username = 'contato.restro@gmail.com';        
        // Senha do E-mail         
        $mail->Password = '3bvxgrzn';                           
        ...
        // Destinatário
        $mail->addAddress('contato.restro@gmail.com', 'Restro Bar');
